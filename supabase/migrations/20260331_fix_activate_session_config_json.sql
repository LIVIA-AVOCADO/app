-- ============================================================
-- Migration: corrige activate_session — usa config_json
-- ============================================================
-- Problema: step 17 do activate_session usava a coluna
--   provider_external_channel_id (DROPADA pela consolidação)
--   e não setava config_json, connection_status,
--   is_receiving_messages, is_sending_messages.
--
-- Correção: INSERT usa config_json com todos os campos que
--   o onboarding/evolution/instance/route.ts salva no step
--   payload (instance_name, instance_id, apikey_instance,
--   webhook_url, evolution_api_url, settings).
-- ============================================================
